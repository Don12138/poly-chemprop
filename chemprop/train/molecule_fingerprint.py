...
from chemprop.features import set_reaction, set_explicit_h, set_adding_hs, reset_featurization_parameters, set_polymer,set_graph_cache_path
...
def molecule_fingerprint(args: FingerprintArgs, smiles: List[List[str]] = None) -> List[List[Optional[float]]]:
    ...
    set_graph_cache_path(train_args.graph_cache_path)
