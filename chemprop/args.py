...
class CommonArgs(Tap):
    ...
    # attn_enc_hidden_size:int = 256
    attn_enc_heads:int = 8
    attn_enc_filter_size:int = 256
    attn_dropout:float = 0.0
    dropout:float = 0.0
    max_path_distance:int = 100
    max_degree = 5
    max_atom_len:int = 52   #统计出来的
    encoder_type: str = "wDMPNN_pyG"
    with_pe:bool=False
...
class TrainArgs(CommonArgs):
    ...
    """Activation function."""
    init:Literal["constant","xavier_uniform",'xavier_normal','kaiming_uniform','kaiming_normal']="xavier_uniform"
